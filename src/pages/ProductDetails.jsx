...
export default function ProductDetails() {
  const { id } = useParams(); // Pega o número da URL (/product/1)
  ...
  if (loading) {
    return <div className="min-h-screen flex justify-center items-center"><Loader className="animate-spin text-pink-600" /></div>;
  }

  if (!product) {
    return <div className="min-h-screen flex justify-center items-center">Produto não encontrado.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Botão Voltar */}
        <Link to="/" className="inline-flex items-center text-gray-600 hover:text-pink-600 mb-8 transition">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 bg-gray-100 flex items-center justify-center p-8">
            <img 
              src={product.imgUrl || "https://via.placeholder.com/600x600?text=Sem+Imagem"} 
              alt={product.name} 
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  {product.affiliateUrl && (
                    <p className="text-xs text-gray-400 mt-1 italic">⚠️ Preço sujeito a alteração no site parceiro</p>
                  )}
                </div>
              </div>
